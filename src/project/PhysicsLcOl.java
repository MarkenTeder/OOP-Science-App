 ...
 * @author x14111021
 */
public class PhysicsLcOl extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PhysicsLcOl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
