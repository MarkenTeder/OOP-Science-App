 ...
 * @author x14110822
 */
public class BiologyLcOl extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BiologyLcOl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
